...
Designed with an Apple-inspired UI language — clean, calm, and distraction-free.
...
```bash
git clone https://github.com/yourusername/focusorb.git
```
...
Because productivity tools should feel calm — not loud.

FocusOrb is a tiny floating companion that helps you focus without getting in your way.
